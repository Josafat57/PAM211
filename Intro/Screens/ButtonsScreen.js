...
export default function ButtonsScreen() {
  ...
  const backgroundColor = prendido ? '#F5F5F5' : '#000000ff';
  ...
  return(
    <View style={[styles.container, { backgroundColor }]}>
      ...
      <Text style={styles.textoBoton}>Prender</Text> </TouchableOpacity>

      <TouchableOpacity style={styles.botonApagar} onPress={() => setPrendido(false)}>
      <Text style={styles.textoBoton}>Apagar</Text> </TouchableOpacity>
